...
function App() {
  return (
    <BrowserRouter>
      <AuthProvider>
        {/* Mounted above the router so training state + the training websocket
            survive page navigation (progress persists when leaving Monitor and
            returning). Inside AuthProvider so it reads the auth token. */}
        <MonitorProvider>
